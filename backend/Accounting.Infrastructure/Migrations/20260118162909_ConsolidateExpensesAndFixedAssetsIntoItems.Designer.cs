...
namespace Accounting.Infrastructure.Migrations
{
    ...
    [Migration("20260118162909_ConsolidateExpensesAndFixedAssetsIntoItems")]
    partial class ConsolidateExpensesAndFixedAssetsIntoItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.Property<decimal>("TotalLineGross")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("TotalWithholding")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<DateTime?>("WaybillDateUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Accounting.Domain.Entities.Contact", b =>
                {
                    ...
                    b.OwnsOne("Accounting.Domain.Entities.CompanyDetails", "CompanyDetails", b1 =>
                        {
                            b1.Property<int>("ContactId")
                                .HasColumnType("int");

                            b1.Property<string>("MersisNo")
                                .HasMaxLength(20)
                                .HasColumnType("nvarchar(20)");
                            ...
                            b1.Property<string>("TicaretSicilNo")
                                .HasMaxLength(20)
                                .HasColumnType("nvarchar(20)");

                            b1.HasKey("ContactId");

                            b1.ToTable("CompanyDetails", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("ContactId");
                        });

                    b.OwnsOne("Accounting.Domain.Entities.PersonDetails", "PersonDetails", b1 =>
                        {
                            b1.Property<int>("ContactId")
                                .HasColumnType("int");
                            ...
                            b1.ToTable("PersonDetails", (string)null);

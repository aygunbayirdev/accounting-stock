...
public class GetStockMovementByIdHandler(IAppDbContext db, ICurrentUserService currentUserService) : IRequestHandler<GetStockMovementByIdQuery, StockMovementDetailDto>
{
